    ...
    <div className="mx-auto max-w-xl space-y-6">
      <div className="space-y-1.5 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Add as many work experineces as you like
        </p>
      </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-between gap-2">
        ...
        />
        <FormDescription>
          Write each experience as a separate sentence and end it with a{" "}
          <span className="font-semibold">period (++)</span>. Each sentence will
          be shown as a separate at resume.
        </FormDescription>
